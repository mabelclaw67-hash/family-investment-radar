...
const STRINGS = {
  en: {
    ...
    nav_stock_lookup:      "Look Up a Stock",
    nav_stock_analysis:    "Stock Radar",
    nav_learning:          "Learning Center",
    nav_decisions:         "Decision Log",
    nav_settings:          "Settings",
    nav_forum:             "What Others Watch",
    nav_forum_admin:       "Forum Management",
    nav_share:             "Share",
    nav_morning_brief:     "Morning Brief",
    nav_admin_learning:    "Learning Content",
    ...
    mtab_decisions:        "Log",
    mtab_stock_lookup:     "Look Up",
    mtab_stock_analysis:   "Stocks",
    stock_lookup_title:        "Look Up a Stock",
    stock_lookup_subtitle:     "Search any US or Canadian stock or ETF by ticker or company name.",
    stock_lookup_placeholder:  "Enter ticker or company name, e.g. AAPL or Apple",
    stock_lookup_button:       "Search",
    stock_lookup_scope:        "Covers US (NASDAQ / NYSE / AMEX) and Canada (TSX / TSXV), including ETFs.",
    stock_lookup_pick:         "Multiple matches found. Tap one to view details:",
    stock_lookup_loading:      "Searching...",
    stock_lookup_none:         "No matching stock or company found. Please check the ticker or name.",
    stock_lookup_private:      "Private company — no public ticker available.",
    stock_lookup_error:        "Lookup failed. Please try again later.",
    stock_lookup_disclaimer:   "Public market data for reference only. Not investment advice.",
    stock_f_exchange:          "Exchange",
    stock_f_country:           "Country / Region",
    stock_f_currency:          "Currency",
    stock_f_marketcap:         "Market Cap",
    stock_f_sector:            "Sector",
    stock_f_industry:          "Industry",
    stock_f_description:       "Company Overview",
    stock_f_source:            "Data Source",
    stock_data_updated:        "Data updated:",
    stock_lookup_refresh:      "Refresh data",
    mtab_market:           "Market",
    mtab_alerts:           "Alerts",
    mtab_news:             "News",
    mtab_forum:            "Forum",
    mtab_share:            "Share",
    mtab_learning:         "Learn",
    forum_title:           "What Others Watch",
    forum_subtitle:        "A light discussion space for Chinese-speaking investors to share stocks, ETFs, or market questions.",
    forum_disclaimer:      "Content here is community discussion, not investment advice. Investing carries risk — use your own judgment.",
    forum_post_warning:    "Please do not post ads, stock-tip groups, guaranteed-return claims, personal contact details, or misleading investment info.",
    forum_new_topic:       "Post a Topic",
    forum_recent:          "Recent Topics",
    forum_empty:           "No public topics yet — be the first to share what you're watching.",
    forum_loading:         "Loading...",
    forum_back:            "Back to list",
    forum_replies:         "Replies",
    forum_no_replies:      "No replies yet.",
    forum_reply_title:     "Post a Reply",
    forum_f_nickname:      "Nickname",
    forum_f_ticker:        "Ticker / Company (optional)",
    forum_f_ticker_ph:     "e.g. AAPL",
    forum_f_title:         "Title",
    forum_f_content:       "Content",
    forum_f_reply:         "Reply",
    forum_antibot_label:   "Anti-bot check: 2 + 3 = ?",
    forum_btn_post:        "Post Topic",
    forum_btn_reply:       "Submit Reply",
    forum_submitting:      "Submitting...",
    forum_post_success:    "Posted successfully.",
    forum_error:           "Something went wrong. Please try again later.",
    forum_admin_title:     "Forum Management",
    forum_admin_subtitle:  "Review and moderate public topics and replies. Records are kept; only status changes.",
    admin_learning_title:  "Learning Content Management",
    admin_learning_subtitle:"Reserved admin area for future learning-center content updates.",
    admin_learning_reserved_title:"Reserved Feature",
    admin_learning_reserved_body:"Learning content management feature reserved: later it can be used to add or edit investment terms, stock learning, ETF learning, conservative investor notes, and other content.",
    forum_admin_topics:    "Topics",
    forum_admin_replies:   "Replies",
    forum_admin_topic_ref: "Topic",
    forum_btn_hide:        "Hide",
    forum_btn_restore:     "Restore",
    ...
    daily_brief_title:     "Daily Market Briefs",
    daily_brief_opening:   "US Market Opening Brief",
    daily_brief_closing:   "US Market Closing Brief",
    daily_brief_no_report: "Today's report has not been published yet.",
    daily_brief_open_link: "Open Original Report",
  ...
  zh: {
    ...
    nav_news:              "每日新闻",
    nav_market:            "市场趋势",
    nav_stock_lookup:      "查一只股票",
    nav_stock_analysis:    "投资趋势",
    nav_learning:          "学习中心",
    nav_decisions:         "决策记录",
    nav_settings:          "设置",
    nav_forum:             "大家在关注",
    nav_forum_admin:       "公众话题管理",
    nav_share:             "分享",
    nav_morning_brief:     "今日晨报",
    nav_admin_learning:    "学习内容管理",
    ...
    mtab_watchlist:        "观察",
    mtab_decisions:        "记录",
    mtab_stock_lookup:     "查股票",
    mtab_stock_analysis:   "股市",
    stock_lookup_title:        "查一只股票",
    stock_lookup_subtitle:     "输入股票代码或公司名称，查询美股、加股及 ETF 的公开行情。",
    stock_lookup_placeholder:  "输入代码或公司名称，例如 AAPL 或 Apple",
    stock_lookup_button:       "搜索",
    stock_lookup_scope:        "覆盖美股（NASDAQ / NYSE / AMEX）与加拿大股票（TSX / TSXV），含 ETF。",
    stock_lookup_pick:         "找到多个结果，请点击其中一个查看详情：",
    stock_lookup_loading:      "正在查询...",
    stock_lookup_none:         "暂未找到该股票或公司，请检查代码或名称。",
    stock_lookup_private:      "未上市公司，暂无公开股票代码。",
    stock_lookup_error:        "查询失败，请稍后再试。",
    stock_lookup_disclaimer:   "公开市场数据仅供参考，不构成投资建议。",
    stock_f_exchange:          "交易所",
    stock_f_country:           "国家 / 地区",
    stock_f_currency:          "货币",
    stock_f_marketcap:         "市值",
    stock_f_sector:            "板块",
    stock_f_industry:          "行业",
    stock_f_description:       "公司简介",
    stock_f_source:            "数据来源",
    stock_data_updated:        "数据更新时间：",
    stock_lookup_refresh:      "重新获取",
    mtab_market:           "市场",
    mtab_alerts:           "提醒",
    mtab_news:             "新闻",
    mtab_forum:            "关注",
    ...
    mtab_learning:         "学习",
    forum_title:           "大家在关注",
    forum_subtitle:        "这里是中文投资用户的轻量交流区，可以分享你正在关注的股票、ETF 或市场问题。",
    forum_disclaimer:      "本区内容为网友交流，不构成投资建议。投资有风险，请自行判断。",
    forum_post_warning:    "请勿发布广告、荐股群、保证收益、个人联系方式或误导性投资信息。",
    forum_new_topic:       "发表新话题",
    forum_recent:          "最近话题",
    forum_empty:           "还没有公开话题，欢迎发布第一个关注点。",
    forum_loading:         "加载中...",
    forum_back:            "返回列表",
    forum_replies:         "回复",
    forum_no_replies:      "还没有回复。",
    forum_reply_title:     "发表回复",
    forum_f_nickname:      "昵称",
    forum_f_ticker:        "相关股票/公司（可选）",
    forum_f_ticker_ph:     "例如 AAPL",
    forum_f_title:         "标题",
    forum_f_content:       "内容",
    forum_f_reply:         "回复内容",
    forum_antibot_label:   "防机器人验证：2 + 3 = ?",
    forum_btn_post:        "发布话题",
    forum_btn_reply:       "提交回复",
    forum_submitting:      "正在提交...",
    forum_post_success:    "发布成功。",
    forum_error:           "操作失败，请稍后再试。",
    forum_admin_title:     "公众话题管理",
    forum_admin_subtitle:  "查看并管理公开话题与回复。记录会保留，仅更新状态。",
    admin_learning_title:  "学习内容管理",
    admin_learning_subtitle:"为后续学习中心内容维护预留的管理员区域。",
    admin_learning_reserved_title:"功能预留",
    admin_learning_reserved_body:"学习内容管理功能预留：后续可用于新增/编辑投资术语、股票学习、ETF 学习、保守型投资者注意事项等内容。",
    forum_admin_topics:    "话题管理",
    forum_admin_replies:   "回复管理",
    forum_admin_topic_ref: "话题",
    forum_btn_hide:        "隐藏",
    forum_btn_restore:     "恢复",
    forum_btn_delete:      "删除",
    mtab_admin_login:      "管理",
    ...
    daily_brief_title:     "每日市场简报",
    daily_brief_opening:   "美股开市简报",
    daily_brief_closing:   "美股收市简报",
    daily_brief_no_report: "今日报告尚未更新",
    daily_brief_open_link: "打开原始报告",
