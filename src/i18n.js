...
const STRINGS = {
  en: {
    ...
    ai_radar_no_saved_summary:"No AI investment trend analysis is available yet. Please ask the admin to update it.",
  ...
  zh: {
    ...
    ai_radar_no_saved_summary:"暂无 AI 投资趋势分析，请管理员更新。",
