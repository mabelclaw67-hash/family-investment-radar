...
const STRINGS = {
  en: {
    ...
    ai_radar_us_text:      "Firecrawl + AI summary will be connected later. Static placeholder for public homepage layout testing.",
    ...
    ai_radar_watch_title:  "Need Attention",
    ...
    ai_trend_no_data:      "No data available yet.",
  ...
  zh: {
    ...
    ai_radar_us_text:      "等待接入 Firecrawl + AI 摘要。当前先展示静态占位，用于公开版首页布局测试。",
